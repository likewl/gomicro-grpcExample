...
type ProdService interface {
	GetProd(ctx context.Context, in *Req, opts ...client.CallOption) (*Rsp, error)
}
...
func (c *prodService) GetProd(ctx context.Context, in *Req, opts ...client.CallOption) (*Rsp, error) {
...
func (h *prodServiceHandler) GetProd(ctx context.Context, in *Req, out *Rsp) error {
